...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (tempPokemon.attackLevel < 1 && tempPokemon.attackLevel > (tempPokemon.hitPoints - 1)) {
        ...
        while (tempPokemon.defenseLevel < 1 && tempPokemon.defenseLevel > (tempPokemon.hitPoints - tempPokemon.attackLevel)) {
            System.out.println("Sorry. The defense level must be between 1 and " + (tempPokemon.hitPoints - 1));
            tempPokemon.defenseLevel = myScan.nextInt();
        }
